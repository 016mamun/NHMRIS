...
class AppTranslations {
  static const Map<String, Map<String, String>> _dict = {
    ...
    'সপ্তাহ': {'বাংলা': 'সপ্তাহ', 'English': 'Week'},
    ...
    'শিশুর সাপ্তাহিক বিকাশ ট্র্যাক করুন': {'বাংলা': 'শিশুর সাপ্তাহিক বিকাশ ট্র্যাক করুন', 'English': 'Track your baby\'s weekly development'},
    ...
    // Weekly Update Screen - Baby Sizes
    'ভুট্টা': {'বাংলা': 'ভুট্টা', 'English': 'Corn'},
    'ফুলকপি': {'বাংলা': 'ফুলকপি', 'English': 'Cauliflower'},
    'লেটুস': {'বাংলা': 'লেটুস', 'English': 'Lettuce'},
    'বাঁধাকপি': {'বাংলা': 'বাঁধাকপি', 'English': 'Cabbage'},
    'বেগুন': {'বাংলা': 'বেগুন', 'English': 'Eggplant'},
    'আনারস': {'বাংলা': 'আনারস', 'English': 'Pineapple'},
    'তরমুজ': {'বাংলা': 'তরমুজ', 'English': 'Watermelon'},
    'নারকেল': {'বাংলা': 'নারকেল', 'English': 'Coconut'},
    'রোমেইন লেটুস': {'বাংলা': 'রোমেইন লেটুস', 'English': 'Romaine Lettuce'},
    'কুমড়া': {'বাংলা': 'কুমড়া', 'English': 'Pumpkin'},
    'র মতো': {'বাংলা': 'র মতো', 'English': 'size of'},
    '৬০০ গ্রাম': {'বাংলা': '৬০০ গ্রাম', 'English': '600g'},
    '৩০ সেমি': {'বাংলা': '৩০ সেমি', 'English': '30cm'},
    '৬৬০ গ্রাম': {'বাংলা': '৬৬০ গ্রাম', 'English': '660g'},
    '৩৪ সেমি': {'বাংলা': '৩৪ সেমি', 'English': '34cm'},
    '৭৬০ গ্রাম': {'বাংলা': '৭৬০ গ্রাম', 'English': '760g'},
    '৩৫ সেমি': {'বাংলা': '৩৫ সেমি', 'English': '35cm'},
    '৮৭৫ গ্রাম': {'বাংলা': '৮৭৫ গ্রাম', 'English': '875g'},
    '৩৬ সেমি': {'বাংলা': '৩৬ সেমি', 'English': '36cm'},
    '১.১ কেজি': {'বাংলা': '১.১ কেজি', 'English': '1.1kg'},
    '৩৭.৬ সেমি': {'বাংলা': '৩৭.৬ সেমি', 'English': '37.6cm'},
    '১.২ কেজি': {'বাংলা': '১.২ কেজি', 'English': '1.2kg'},
    '৩৮ সেমি': {'বাংলা': '৩৮ সেমি', 'English': '38cm'},
    '১.৩ কেজি': {'বাংলা': '১.৩ কেজি', 'English': '1.3kg'},
    '৪০ সেমি': {'বাংলা': '৪০ সেমি', 'English': '40cm'},
    '১.৭ কেজি': {'বাংলা': '১.৭ কেজি', 'English': '1.7kg'},
    '৪২ সেমি': {'বাংলা': '৪২ সেমি', 'English': '42cm'},
    '২.৬ কেজি': {'বাংলা': '২.৬ কেজি', 'English': '2.6kg'},
    '৪৭ সেমি': {'বাংলা': '৪৭ সেমি', 'English': '47cm'},
    '৩.৪ কেজি': {'বাংলা': '৩.৪ কেজি', 'English': '3.4kg'},
    '৫১ সেমি': {'বাংলা': '৫১ সেমি', 'English': '51cm'},

    // Weekly Update Screen - Development/Mother/Advice Text
    'শিশুর চোখ খুলতে শুরু করেছে। ঘুম-জাগার ছন্দ তৈরি হচ্ছে। এ সময় বেবির চোখের পাতার সংবেদনশীলতা বৃদ্ধি পায়।': {'বাংলা': 'শিশুর চোখ খুলতে শুরু করেছে। ঘুম-জাগার ছন্দ তৈরি হচ্ছে। এ সময় বেবির চোখের পাতার সংবেদনশীলতা বৃদ্ধি পায়।', 'English': 'Baby\'s eyes are starting to open. Sleep-wake cycle is forming. Eye sensitivity is increasing at this time.'},
    'গর্ভাশয়ের আকার বৃদ্ধির সাথে সাথে পিঠ ও কোমরে ব্যথা হতে পারে। ত্বকে সামান্য স্ট্রেচ মার্ক দেখা দিতে পারে।': {'বাংলা': 'গর্ভাশয়ের আকার বৃদ্ধির সাথে সাথে পিঠ ও কোমরে ব্যথা হতে পারে। ত্বকে সামান্য স্ট্রেচ মার্ক দেখা দিতে পারে।', 'English': 'Back and waist pain may occur as the uterus grows. Slight stretch marks may appear on the skin.'},
    'হাঁটার সময় মেরুদণ্ড সোজা রাখুন এবং ভারী কিছু বহন করা এড়িয়ে চলুন। বাম কাতে শোয়ার অভ্যাস করুন।': {'বাংলা': 'হাঁটার সময় মেরুদণ্ড সোজা রাখুন এবং ভারী কিছু বহন করা এড়িয়ে চলুন। বাম কাতে শোয়ার অভ্যাস করুন।', 'English': 'Keep your spine straight while walking and avoid carrying heavy things. Practice sleeping on your left side.'},
    'শিশু এখন বাইরের আওয়াজ খুব স্পষ্ট শুনতে পাচ্ছে। হৃদস্পন্দন আরও শক্তিশালী হয়েছে।': {'বাংলা': 'শিশু এখন বাইরের আওয়াজ খুব স্পষ্ট শুনতে পাচ্ছে। হৃদস্পন্দন আরও শক্তিশালী হয়েছে।', 'English': 'Baby can now hear outside sounds very clearly. Heartbeat has become even stronger.'},
    'পায়ের গোড়ালি এবং শরীরে হালকা পানি জমতে পারে। বদহজমের সমস্যা কিছুটা বাড়তে পারে।': {'বাংলা': 'পায়ের গোড়ালি এবং শরীরে হালকা পানি জমতে পারে। বদহজমের সমস্যা কিছুটা বাড়তে পারে।', 'English': 'Mild swelling may occur in ankles and body. Indigestion problems may increase slightly.'},
    'পর্যাপ্ত পানি পান করুন এবং দীর্ঘক্ষণ একটানা দাঁড়িয়ে থাকবেন না। শোবার সময় পা কিছুটা উঁচুতে রাখুন।': {'বাংলা': 'পর্যাপ্ত পানি পান করুন এবং দীর্ঘক্ষণ একটানা দাঁড়িয়ে থাকবেন না। শোবার সময় পা কিছুটা উঁচুতে রাখুন।', 'English': 'Drink adequate water and avoid standing for long periods. Keep your feet slightly elevated while sleeping.'},
    'শিশুর ফুসফুস ও রক্তনালীগুলো তৈরি হচ্ছে। চোখের পাতা আলাদা হচ্ছে এবং আলো অনুভব করতে পারছে।': {'বাংলা': 'শিশুর ফুসফুস ও রক্তনালীগুলো তৈরি হচ্ছে। চোখের পাতা আলাদা হচ্ছে এবং আলো অনুভব করতে পারছে।', 'English': 'Baby\'s lungs and blood vessels are forming. Eyelids are separating and can perceive light.'},
    'পেটের ওপর হালকা চুলকানি বা স্ট্রেচ মার্কস দেখা দিতে পারে। নাভি বাইরের দিকে প্রসারিত হতে পারে।': {'বাংলা': 'পেটের ওপর হালকা চুলকানি বা স্ট্রেচ মার্কস দেখা দিতে পারে। নাভি বাইরের দিকে প্রসারিত হতে পারে।', 'English': 'Mild itching or stretch marks may appear on the stomach. The navel may protrude outward.'},
    'অলিভ অয়েল বা ভালো ময়েশ্চারাইজার পেটে মালিশ করতে পারেন। ঢিলেঢালা সুতির পোশাক পরিধান করুন।': {'বাংলা': 'অলিভ অয়েল বা ভালো ময়েশ্চারাইজার পেটে মালিশ করতে পারেন। ঢিলেঢালা সুতির পোশাক পরিধান করুন।', 'English': 'You can massage your stomach with olive oil or good moisturizer. Wear loose cotton clothing.'},
    'শিশুর মস্তিষ্কের দ্রুত বিকাশ হচ্ছে এবং সে এখন নিয়মিত বিরতিতে চোখ পিটপিট করতে পারছে।': {'বাংলা': 'শিশুর মস্তিষ্কের দ্রুত বিকাশ হচ্ছে এবং সে এখন নিয়মিত বিরতিতে চোখ পিটপিট করতে পারছে।', 'English': 'Baby\'s brain is developing rapidly and can now blink eyes at regular intervals.'},
    'হালকা শ্বাসকষ্ট বা বুক ধড়ফড়ানি হতে পারে। গর্ভাশয় নাভির উপরে উঠে আসে।': {'বাংলা': 'হালকা শ্বাসকষ্ট বা বুক ধড়ফড়ানি হতে পারে। গর্ভাশয় নাভির উপরে উঠে আসে।', 'English': 'Mild shortness of breath or chest tightness may occur. The uterus rises above the navel.'},
    'বিশ্রাম নেওয়ার সময় বাম কাতে কাত হয়ে শোন। প্রতিদিন পুষ্টিকর ক্যালসিয়াম ও আয়রনযুক্ত খাবার খান।': {'বাংলা': 'বিশ্রাম নেওয়ার সময় বাম কাতে কাত হয়ে শোন। প্রতিদিন পুষ্টিকর ক্যালসিয়াম ও আয়রনযুক্ত খাবার খান।', 'English': 'Sleep on your left side while resting. Eat nutritious food rich in calcium and iron daily.'},
    'এ সময় বেবির ফুসফুস আরও শক্তিশালী হচ্ছে এবং ওজন দ্রুত বাড়ছে। বেবি এখন বাইরের শব্দ শুনতে পারে।': {'বাংলা': 'এ সময় বেবির ফুসফুস আরও শক্তিশালী হচ্ছে এবং ওজন দ্রুত বাড়ছে। বেবি এখন বাইরের শব্দ শুনতে পারে।', 'English': 'Baby\'s lungs are becoming stronger and weight is increasing rapidly. Baby can now hear outside sounds.'},
    'গর্ভাশয় বুকের খাঁচার কাছে চলে আসায় সামান্য শ্বাসকষ্ট হতে পারে এবং পা সামান্য ফুলতে পারে।': {'বাংলা': 'গর্ভাশয় বুকের খাঁচার কাছে চলে আসায় সামান্য শ্বাসকষ্ট হতে পারে এবং পা সামান্য ফুলতে পারে।', 'English': 'Mild shortness of breath may occur as the uterus moves near the chest cavity and feet may swell slightly.'},
    'প্রতিদিন শিশুর নড়াচড়া (কিক) কমপক্ষে ১০ বার হচ্ছে কিনা তা ট্র্যাক করুন। প্রয়োজনে কিক কাউন্টার ব্যবহার করুন।': {'বাংলা': 'প্রতিদিন শিশুর নড়াচড়া (কিক) কমপক্ষে ১০ বার হচ্ছে কিনা তা ট্র্যাক করুন। প্রয়োজনে কিক কাউন্টার ব্যবহার করুন।', 'English': 'Track whether baby\'s movements (kicks) occur at least 10 times daily. Use kick counter if needed.'},
    'হাড় শক্ত হচ্ছে, মাংসপেশী শক্তিশালী হচ্ছে এবং শিশুটি আলোর গতিবিধি অনুসরণ করার চেষ্টা করছে।': {'বাংলা': 'হাড় শক্ত হচ্ছে, মাংসপেশী শক্তিশালী হচ্ছে এবং শিশুটি আলোর গতিবিধি অনুসরণ করার চেষ্টা করছে।', 'English': 'Bones are strengthening, muscles are becoming stronger and the baby is trying to follow light movements.'},
    'ঘন ঘন প্রস্রাবের বেগ হতে পারে এবং কোষ্ঠকাঠিন্যের সমস্যা বৃদ্ধি পেতে পারে।': {'বাংলা': 'ঘন ঘন প্রস্রাবের বেগ হতে পারে এবং কোষ্ঠকাঠিন্যের সমস্যা বৃদ্ধি পেতে পারে।', 'English': 'Frequent urge to urinate may occur and constipation problems may increase.'},
    'খাদ্যতালিকায় প্রচুর আঁশযুক্ত খাবার, সবুজ শাকসবজি এবং তাজা ফলমূল রাখুন। প্রচুর পানি পান করুন।': {'বাংলা': 'খাদ্যতালিকায় প্রচুর আঁশযুক্ত খাবার, সবুজ শাকসবজি এবং তাজা ফলমূল রাখুন। প্রচুর পানি পান করুন।', 'English': 'Include plenty of fiber-rich foods, green vegetables and fresh fruits in your diet. Drink plenty of water.'},
    'শিশুর মস্তিষ্কে লাখ লাখ নিউরন তৈরি হচ্ছে এবং তার নড়াচড়া আরও জোরালো হচ্ছে।': {'বাংলা': 'শিশুর মস্তিষ্কে লাখ লাখ নিউরন তৈরি হচ্ছে এবং তার নড়াচড়া আরও জোরালো হচ্ছে।', 'English': 'Millions of neurons are forming in the baby\'s brain and movements are becoming stronger.'},
    'সহজেই ক্লান্তিভাব আসবে এবং ঘুমাতে কিছুটা সমস্যা হতে পারে। পিঠের ব্যথা বাড়তে পারে।': {'বাংলা': 'সহজেই ক্লান্তিভাব আসবে এবং ঘুমাতে কিছুটা সমস্যা হতে পারে। পিঠের ব্যথা বাড়তে পারে।', 'English': 'Fatigue will come easily and there may be some trouble sleeping. Back pain may increase.'},
    'শোবার ঘরে হালকা আলো রাখুন এবং ঘুমানোর আগে মোবাইল ফোন ব্যবহার করবেন না। কুসুম গরম পানিতে গোসল করতে পারেন।': {'বাংলা': 'শোবার ঘরে হালকা আলো রাখুন এবং ঘুমানোর আগে মোবাইল ফোন ব্যবহার করবেন না। কুসুম গরম পানিতে গোসল করতে পারেন।', 'English': 'Keep dim light in the bedroom and do not use mobile phone before sleeping. You can take a bath in lukewarm water.'},
    'শিশু এখন মাথা নিচে নামিয়ে নেওয়ার চেষ্টা করছে। হাত ও পায়ের নখগুলো সম্পূর্ণ বিকশিত হয়েছে।': {'বাংলা': 'শিশু এখন মাথা নিচে নামিয়ে নেওয়ার চেষ্টা করছে। হাত ও পায়ের নখগুলো সম্পূর্ণ বিকশিত হয়েছে।', 'English': 'Baby is now trying to move head down. Fingernails and toenails are fully developed.'},
    'ব্র্যাক্সটন হিকস (Braxton Hicks) সংকোচন বা ফলস লেবার পেইন মাঝেমধ্যে হতে পারে।': {'বাংলা': 'ব্র্যাক্সটন হিকস (Braxton Hicks) সংকোচন বা ফলস লেবার পেইন মাঝেমধ্যে হতে পারে।', 'English': 'Braxton Hicks contractions or false labor pain may occur occasionally.'},
    'যদি সংকোচন বা ব্যথা খুব তীব্র ও ঘন ঘন হয়, তবে অবিলম্বে চিকিৎসকের পরামর্শ নিন। হাঁটাচলা সচল রাখুন।': {'বাংলা': 'যদি সংকোচন বা ব্যথা খুব তীব্র ও ঘন ঘন হয়, তবে অবিলম্বে চিকিৎসকের পরামর্শ নিন। হাঁটাচলা সচল রাখুন।', 'English': 'If contractions or pain become very intense and frequent, consult a doctor immediately. Keep walking active.'},
    'শিশু প্রায় সম্পূর্ণ বিকাশ লাভ করেছে। তার মেদ বাড়ছে এবং ত্বক মসৃণ হচ্ছে।': {'বাংলা': 'শিশু প্রায় সম্পূর্ণ বিকাশ লাভ করেছে। তার মেদ বাড়ছে এবং ত্বক মসৃণ হচ্ছে।', 'English': 'Baby has achieved almost full development. Fat is increasing and skin is becoming smooth.'},
    'শিশুর মাথা শ্রোণীতে নেমে আসায় শ্বাস নিতে আগের চেয়ে সহজ লাগবে, কিন্তু হাঁটতে সমস্যা হতে পারে।': {'বাংলা': 'শিশুর মাথা শ্রোণীতে নেমে আসায় শ্বাস নিতে আগের চেয়ে সহজ লাগবে, কিন্তু হাঁটতে সমস্যা হতে পারে।', 'English': 'Breathing will feel easier than before as baby\'s head descends into the pelvis, but walking may be difficult.'},
    'ডেলিভারির জন্য হাসপাতাল ব্যাগ এবং জরুরি রক্তের দাতা ঠিক রাখুন। নিয়মিত চেকআপ বজায় রাখুন।': {'বাংলা': 'ডেলিভারির জন্য হাসপাতাল ব্যাগ এবং জরুরি রক্তের দাতা ঠিক রাখুন। নিয়মিত চেকআপ বজায় রাখুন।', 'English': 'Keep hospital bag ready for delivery and emergency blood donor. Keep regular checkups.'},
    'শিশু ডেলিভারির জন্য প্রস্তুত! গর্ভের বাইরে আসার জন্য সম্পূর্ণ সুস্থ ও বিকশিত।': {'বাংলা': 'শিশু ডেলিভারির জন্য প্রস্তুত! গর্ভের বাইরে আসার জন্য সম্পূর্ণ সুস্থ ও বিকশিত।', 'English': 'Baby is ready for delivery! Completely healthy and developed to come out of the womb.'},
    'যেকোনো সময় প্রসব বেদনা উঠতে পারে বা অ্যামনিয়াটিক ফ্লুইড বের হতে পারে। শ্রোণীতে চাপ অনুভব করবেন।': {'বাংলা': 'যেকোনো সময় প্রসব বেদনা উঠতে পারে বা অ্যামনিয়াটিক ফ্লুইড বের হতে পারে। শ্রোণীতে চাপ অনুভব করবেন।', 'English': 'Labor pain may start at any time or amniotic fluid may leak. You will feel pressure in the pelvis.'},
    'শান্ত থাকুন এবং পরিবারের লোকজনকে নিয়ে প্রস্তুত থাকুন। অবিলম্বে হাসপাতালে যাওয়ার জন্য যানবাহন প্রস্তুত রাখুন।': {'বাংলা': 'শান্ত থাকুন এবং পরিবারের লোকজনকে নিয়ে প্রস্তুত থাকুন। অবিলম্বে হাসপাতালে যাওয়ার জন্য যানবাহন প্রস্তুত রাখুন।', 'English': 'Stay calm and be prepared with family members. Keep transportation ready to go to hospital immediately.'},
    '১ম ট্রাইমিস্টার': {'বাংলা': '১ম ট্রাইমিস্টার', 'English': '1st Trimester'},
    '২য় ট্রাইমিস্টার': {'বাংলা': '২য় ট্রাইমিস্টার', 'English': '2nd Trimester'},
    '৩য় ট্রাইমিস্টার': {'বাংলা': '৩য় ট্রাইমিস্টার', 'English': '3rd Trimester'},
    'বেবির বিকাশ': {'বাংলা': 'বেবির বিকাশ', 'English': 'Baby Development'},
    'মায়ের শরীরে পরিবর্তন': {'বাংলা': 'মায়ের শরীরে পরিবর্তন', 'English': 'Mother\'s Body Changes'},
    'সপ্তাহ নির্বাচন করুন': {'বাংলা': 'সপ্তাহ নির্বাচন করুন', 'English': 'Select Week'},
    'আপনার বেবি': {'বাংলা': 'আপনার বেবি', 'English': 'Your Baby'},
    'দৈর্ঘ্য': {'বাংলা': 'দৈর্ঘ্য', 'English': 'Length'},
    'ওজন': {'বাংলা': 'ওজন', 'English': 'Weight'},
    'বেবির আকার': {'বাংলা': 'বেবির আকার', 'English': 'Baby Size'},
    'নিরাপদ': {'বাংলা': 'নিরাপদ', 'English': 'Safe'},
    'আরও বিস্তারিত পড়ুন': {'বাংলা': 'আরও বিস্তারিত পড়ুন', 'English': 'Read More'},
    'সপ্তাহের গাইড': {'বাংলা': 'সপ্তাহের গাইড', 'English': 'Week Guide'},
    'মায়ের শরীর': {'বাংলা': 'মায়ের শরীর', 'English': 'Mother\'s Body'},
    'ডাক্তারের পরামর্শ': {'বাংলা': 'ডাক্তারের পরামর্শ', 'English': 'Doctor\'s Advice'},
