...
class AppTranslations {
  static const Map<String, Map<String, String>> _dict = {
    ...
    // Daily Tips Screen
    'প্রতিদিনের স্বাস্থ্য টিপস': {'বাংলা': 'প্রতিদিনের স্বাস্থ্য টিপস', 'English': 'Daily Health Tips'},
    'সব': {'বাংলা': 'সব', 'English': 'All'},
    'ঘুম': {'বাংলা': 'ঘুম', 'English': 'Sleep'},
    'মানসিক': {'বাংলা': 'মানসিক', 'English': 'Mental'},
    'প্রতিদিন সবুজ শাক খান': {'বাংলা': 'প্রতিদিন সবুজ শাক খান', 'English': 'Eat Green Vegetables Daily'},
    'পালংশাক, লালশাক, ও পুইশাক আয়রন ও ফলিক অ্যাসিডের দুর্দান্ত উৎস। গর্ভাবস্থায় প্রতিদিন এক বাটি সবুজ শাক খেলে রক্তশূন্যতা দূর হয় এবং শিশুর মস্তিষ্কের বিকাশ সঠিক হয়।': {'বাংলা': 'পালংশাক, লালশাক, ও পুইশাক আয়রন ও ফলিক অ্যাসিডের দুর্দান্ত উৎস। গর্ভাবস্থায় প্রতিদিন এক বাটি সবুজ শাক খেলে রক্তশূন্যতা দূর হয় এবং শিশুর মস্তিষ্কের বিকাশ সঠিক হয়।', 'English': 'Spinach, red amaranth, and basella are excellent sources of iron and folic acid. Eating a bowl of green vegetables daily during pregnancy prevents anemia and ensures proper brain development of the baby.'},
    'দুধ ও ক্যালসিয়াম': {'বাংলা': 'দুধ ও ক্যালসিয়াম', 'English': 'Milk & Calcium'},
    'গর্ভাবস্থায় প্রতিদিন কমপক্ষে ২ গ্লাস দুধ বা দুগ্ধজাত খাবার (দই, পনির) খান। ক্যালসিয়াম শিশুর হাড়, দাঁত ও পেশী গঠনে অপরিহার্য।': {'বাংলা': 'গর্ভাবস্থায় প্রতিদিন কমপক্ষে ২ গ্লাস দুধ বা দুগ্ধজাত খাবার (দই, পনির) খান। ক্যালসিয়াম শিশুর হাড়, দাঁত ও পেশী গঠনে অপরিহার্য।', 'English': 'Drink at least 2 glasses of milk or dairy products (yogurt, cheese) daily during pregnancy. Calcium is essential for the baby\'s bones, teeth, and muscles.'},
    'সকালে হালকা হাঁটুন': {'বাংলা': 'সকালে হালকা হাঁটুন', 'English': 'Light Morning Walk'},
    'প্রতিদিন সকালে ১৫–২০ মিনিট ধীর গতিতে হাঁটলে রক্ত সঞ্চালন ভালো থাকে, পা ফোলা কমে এবং প্রসব সহজ হয়। যেকোনো ব্যায়াম শুরুর আগে ডাক্তারের পরামর্শ নিন।': {'বাংলা': 'প্রতিদিন সকালে ১৫–২০ মিনিট ধীর গতিতে হাঁটলে রক্ত সঞ্চালন ভালো থাকে, পা ফোলা কমে এবং প্রসব সহজ হয়। যেকোনো ব্যায়াম শুরুর আগে ডাক্তারের পরামর্শ নিন।', 'English': 'A slow walk for 15-20 minutes every morning improves blood circulation, reduces foot swelling, and makes delivery easier. Consult a doctor before starting any exercise.'},
    'পর্যাপ্ত ঘুম নিশ্চিত করুন': {'বাংলা': 'পর্যাপ্ত ঘুম নিশ্চিত করুন', 'English': 'Ensure Adequate Sleep'},
    'গর্ভবতী মায়েদের জন্য রাতে ৮–৯ ঘণ্টা ঘুম এবং দুপুরে ১ ঘণ্টা বিশ্রাম নেওয়া ভালো। বাঁ দিকে কাত হয়ে শোলে জরায়ুতে রক্ত চলাচল সহজ হয়।': {'বাংলা': 'গর্ভবতী মায়েদের জন্য রাতে ৮–৯ ঘণ্টা ঘুম এবং দুপুরে ১ ঘণ্টা বিশ্রাম নেওয়া ভালো। বাঁ দিকে কাত হয়ে শোলে জরায়ুতে রক্ত চলাচল সহজ হয়।', 'English': '8-9 hours of sleep at night and 1 hour of rest at noon is good for pregnant mothers. Sleeping on the left side improves blood flow to the uterus.'},
    'মানসিক চাপ কমান': {'বাংলা': 'মানসিক চাপ কমান', 'English': 'Reduce Mental Stress'},
    'গভীর শ্বাস-প্রশ্বাসের ব্যায়াম, মেডিটেশন বা প্রিয় গান শোনা মানসিক চাপ কমাতে সাহায্য করে। গর্ভাবস্থায় মানসিক স্বাস্থ্য শারীরিক স্বাস্থ্যের মতোই গুরুত্বপূর্ণ।': {'বাংলা': 'গভীর শ্বাস-প্রশ্বাসের ব্যায়াম, মেডিটেশন বা প্রিয় গান শোনা মানসিক চাপ কমাতে সাহায্য করে। গর্ভাবস্থায় মানসিক স্বাস্থ্য শারীরিক স্বাস্থ্যের মতোই গুরুত্বপূর্ণ।', 'English': 'Deep breathing exercises, meditation, or listening to favorite songs help reduce mental stress. Mental health during pregnancy is just as important as physical health.'},
    'পর্যাপ্ত পানি পান করুন': {'বাংলা': 'পর্যাপ্ত পানি পান করুন', 'English': 'Drink Adequate Water'},
    'প্রতিদিন ৮–১০ গ্লাস (২ লিটার) পানি পান করুন। পর্যাপ্ত পানি পান ইউরিনারি ইনফেকশন প্রতিরোধ করে এবং গর্ভের অ্যামনিয়াটিক তরল সঠিক রাখে।': {'বাংলা': 'প্রতিদিন ৮–১০ গ্লাস (২ লিটার) পানি পান করুন। পর্যাপ্ত পানি পান ইউরিনারি ইনফেকশন প্রতিরোধ করে এবং গর্ভের অ্যামনিয়াটিক তরল সঠিক রাখে।', 'English': 'Drink 8-10 glasses (2 liters) of water daily. Adequate water intake prevents urinary infections and maintains amniotic fluid levels.'},
    'Kegel ব্যায়াম করুন': {'বাংলা': 'Kegel ব্যায়াম করুন', 'English': 'Do Kegel Exercises'},
    'Kegel ব্যায়াম শ্রোণিদেশের পেশী মজবুত করে এবং প্রসবের সময় সহায়ক। প্রতিদিন ১০–১৫ বার এই ব্যায়াম করা উচিত। শুয়ে বা বসে যেকোনো অবস্থায় করা যায়।': {'বাংলা': 'Kegel ব্যায়াম শ্রোণিদেশের পেশী মজবুত করে এবং প্রসবের সময় সহায়ক। প্রতিদিন ১০–১৫ বার এই ব্যায়াম করা উচিত। শুয়ে বা বসে যেকোনো অবস্থায় করা যায়।', 'English': 'Kegel exercises strengthen pelvic muscles and help during delivery. Do this 10-15 times daily. Can be done lying or sitting.'},
    'পরিবারের সাথে সময় কাটান': {'বাংলা': 'পরিবারের সাথে সময় কাটান', 'English': 'Spend Time with Family'},
    'প্রিয়জনের সঙ্গে কথা বলুন, আনন্দময় কাজ করুন। একাকীত্ব গর্ভকালীন বিষণ্নতার কারণ হতে পারে। পরিবার ও বন্ধুদের সাপোর্ট মা ও শিশু দুজনের জন্যই উপকারী।': {'বাংলা': 'প্রিয়জনের সঙ্গে কথা বলুন, আনন্দময় কাজ করুন। একাকীত্ব গর্ভকালীন বিষণ্নতার কারণ হতে পারে। পরিবার ও বন্ধুদের সাপোর্ট মা ও শিশু দুজনের জন্যই উপকারী।', 'English': 'Talk to loved ones, do joyful activities. Loneliness can cause pregnancy depression. Support from family and friends benefits both mother and baby.'},

    // Complications Screen
    'গর্ভকালীন জটিলতা': {'বাংলা': 'গর্ভকালীন জটিলতা', 'English': 'Pregnancy Complications'},
    'জরুরি লক্ষণ ও করণীয়': {'বাংলা': 'জরুরি লক্ষণ ও করণীয়', 'English': 'Emergency Signs & Actions'},
    'জরুরি যোগাযোগ': {'বাংলা': 'জরুরি যোগাযোগ', 'English': 'Emergency Contact'},
    'বন্ধ করুন': {'বাংলা': 'বন্ধ করুন', 'English': 'Close'},
    'জরুরি কল': {'বাংলা': 'জরুরি কল', 'English': 'Emergency Call'},

    // Common Problems Screen
    'গর্ভাবস্থায় সাধারণ সমস্যা ও করণীয়': {'বাংলা': 'গর্ভাবস্থায় সাধারণ সমস্যা ও করণীয়', 'English': 'Common Pregnancy Problems & Solutions'},

    // Medicine Guide Screen
    'ল্যাব পরীক্ষা': {'বাংলা': 'ল্যাব পরীক্ষা', 'English': 'Lab Tests'},
    'ডোজ নির্দেশিকা': {'বাংলা': 'ডোজ নির্দেশিকা', 'English': 'Dosage Guide'},

    // Kegel Exercise Screen
    'শ্রোণিদেশের পেশী মজবুত করুন': {'বাংলা': 'শ্রোণিদেশের পেশী মজবুত করুন', 'English': 'Strengthen Pelvic Floor Muscles'},
    'কেন করবেন?': {'বাংলা': 'কেন করবেন?', 'English': 'Why do it?'},
    'সেকেন্ড': {'বাংলা': 'সেকেন্ড', 'English': 'seconds'},
    'ব্যায়াম ট্র্যাকার': {'বাংলা': 'ব্যায়াম ট্র্যাকার', 'English': 'Exercise Tracker'},
    'শুরু করুন': {'বাংলা': 'শুরু করুন', 'English': 'Start'},
    '📋 কীভাবে করবেন?': {'বাংলা': '📋 কীভাবে করবেন?', 'English': '📋 How to do it?'},

    // BMI Calculator Screen
    'শরীরের ভর সূচক নির্ণয়': {'বাংলা': 'শরীরের ভর সূচক নির্ণয়', 'English': 'Body Mass Index Calculator'},
    'সাধারণ BMI': {'বাংলা': 'সাধারণ BMI', 'English': 'Normal BMI'},
    'গর্ভকালীন BMI': {'বাংলা': 'গর্ভকালীন BMI', 'English': 'Pregnancy BMI'},
    'উচ্চতা (সেমি)': {'বাংলা': 'উচ্চতা (সেমি)', 'English': 'Height (cm)'},
    'বর্তমান ওজন (কেজি)': {'বাংলা': 'বর্তমান ওজন (কেজি)', 'English': 'Current Weight (kg)'},
    'ওজন (কেজি)': {'বাংলা': 'ওজন (কেজি)', 'English': 'Weight (kg)'},
    'BMI হিসাব করুন': {'বাংলা': 'BMI হিসাব করুন', 'English': 'Calculate BMI'},
    'আপনার BMI স্কোর': {'বাংলা': 'আপনার BMI স্কোর', 'English': 'Your BMI Score'},
    'BMI রেফারেন্স চার্ট': {'বাংলা': 'BMI রেফারেন্স চার্ট', 'English': 'BMI Reference Chart'},
    'গর্ভাবস্থায় ওজন বৃদ্ধির গাইড': {'বাংলা': 'গর্ভাবস্থায় ওজন বৃদ্ধির গাইড', 'English': 'Pregnancy Weight Gain Guide'},
    'কম ওজন': {'বাংলা': 'কম ওজন', 'English': 'Underweight'},
    'স্বাভাবিক': {'বাংলা': 'স্বাভাবিক', 'English': 'Normal'},
    'অতিরিক্ত ওজন': {'বাংলা': 'অতিরিক্ত ওজন', 'English': 'Overweight'},
    'স্থূলতা': {'বাংলা': 'স্থূলতা', 'English': 'Obesity'},

    // GMP Chart Screen
    'Growth Monitoring Programme — শিশুর বৃদ্ধি পর্যবেক্ষণ': {'বাংলা': 'Growth Monitoring Programme — শিশুর বৃদ্ধি পর্যবেক্ষণ', 'English': 'Growth Monitoring Programme — Baby Growth Tracking'},
    'মেয়ে 👧': {'বাংলা': 'মেয়ে 👧', 'English': 'Girl 👧'},
    'ছেলে 👦': {'বাংলা': 'ছেলে 👦', 'English': 'Boy 👦'},
    'শিশুর বয়স (মাস)': {'বাংলা': 'শিশুর বয়স (মাস)', 'English': 'Baby Age (months)'},
    'বৃদ্ধি পর্যবেক্ষণ করুন': {'বাংলা': 'বৃদ্ধি পর্যবেক্ষণ করুন', 'English': 'Monitor Growth'},
    'স্বাভাবিক বৃদ্ধি': {'বাংলা': 'স্বাভাবিক বৃদ্ধি', 'English': 'Normal Growth'},
    'মাঝারি অপুষ্টি': {'বাংলা': 'মাঝারি অপুষ্টি', 'English': 'Moderate Malnutrition'},
    'মারাত্মক অপুষ্টি': {'বাংলা': 'মারাত্মক অপুষ্টি', 'English': 'Severe Malnutrition'},
    'পর্যবেক্ষণের ইতিহাস': {'বাংলা': 'পর্যবেক্ষণের ইতিহাস', 'English': 'Monitoring History'},
    'বয়স (মাস)': {'বাংলা': 'বয়স (মাস)', 'English': 'Age (months)'},
    'গড় ওজন (কেজি)': {'বাংলা': 'গড় ওজন (কেজি)', 'English': 'Average Weight (kg)'},
    'সঠিক ওজন দিন': {'বাংলা': 'সঠিক ওজন দিন', 'English': 'Enter valid weight'},

    // Kick Counter Screen
    'শিশুর নড়াচড়া ট্র্যাক করুন': {'বাংলা': 'শিশুর নড়াচড়া ট্র্যাক করুন', 'English': 'Track baby movements'},
    'সময়': {'বাংলা': 'সময়', 'English': 'Time'},
    '● চলমান': {'বাংলা': '● চলমান', 'English': '● Running'},
    'শুরু হয়নি': {'বাংলা': 'শুরু হয়নি', 'English': 'Not started'},
    'কিক': {'বাংলা': 'কিক', 'English': 'Kick'},
    '🎉 লক্ষ্য পূরণ!': {'বাংলা': '🎉 লক্ষ্য পূরণ!', 'English': '🎉 Goal reached!'},
    'চমৎকার! ১০টি কিক সম্পন্ন হয়েছে।': {'বাংলা': 'চমৎকার! ১০টি কিক সম্পন্ন হয়েছে।', 'English': 'Excellent! 10 kicks completed.'},
    'নড়াচড়া করলে বাটনে চাপ দিন': {'বাংলা': 'নড়াচড়া করলে বাটনে চাপ দিন', 'English': 'Press button when baby moves'},
    'রিসেট': {'বাংলা': 'রিসেট', 'English': 'Reset'},
    'সাপ্তাহিক কিক রেকর্ড': {'বাংলা': 'সাপ্তাহিক কিক রেকর্ড', 'English': 'Weekly Kick Record'},

    // Blood Donor Screen
    'জরুরি রক্তের গ্রুপ ও দাতা': {'বাংলা': 'জরুরি রক্তের গ্রুপ ও দাতা', 'English': 'Emergency Blood Group & Donors'},
    'রক্তদাতা নিবন্ধন': {'বাংলা': 'রক্তদাতা নিবন্ধন', 'English': 'Donor Registration'},
    'জরুরি রক্তের অনুরোধ': {'বাংলা': 'জরুরি রক্তের অনুরোধ', 'English': 'Emergency Blood Request'},
    'নতুন অনুরোধ': {'বাংলা': 'নতুন অনুরোধ', 'English': 'New Request'},
    'রক্তদাতা খুঁজুন': {'বাংলা': 'রক্তদাতা খুঁজুন', 'English': 'Find Blood Donor'},
    'রক্তদাতা হন': {'বাংলা': 'রক্তদাতা হন', 'English': 'Become Donor'},
    'কল দিন': {'বাংলা': 'কল দিন', 'English': 'Call'},
    'নিবন্ধন করুন': {'বাংলা': 'নিবন্ধন করুন', 'English': 'Register'},
    'অনুরোধ করুন': {'বাংলা': 'অনুরোধ করুন', 'English': 'Request'},
    'উপযুক্ত': {'বাংলা': 'উপযুক্ত', 'English': 'Suitable'},
    'অনুপযুক্ত': {'বাংলা': 'অনুপযুক্ত', 'English': 'Not Suitable'},
    'টোল ফ্রি': {'বাংলা': 'টোল ফ্রি', 'English': 'Toll Free'},
    'সাধারণ রেট': {'বাংলা': 'সাধারণ রেট', 'English': 'Normal Rate'},

    // Helpline Screen
    'জরুরি যোগাযোগ ও হেল্পলাইন': {'বাংলা': 'জরুরি যোগাযোগ ও হেল্পলাইন', 'English': 'Emergency Contacts & Helplines'},
    'জাতীয় জরুরি নম্বরসমূহ': {'বাংলা': 'জাতীয় জরুরি নম্বরসমূহ', 'English': 'National Emergency Numbers'},
    'মাতৃত্ব ও প্রসূতি বিশেষজ্ঞ লাইনসমূহ': {'বাংলা': 'মাতৃত্ব ও প্রসূতি বিশেষজ্ঞ লাইনসমূহ', 'English': 'Maternal & Obstetric Expert Lines'},
    'কল করুন': {'বাংলা': 'কল করুন', 'English': 'Call'},

    // Hospital Directory Screen
    'নিকটস্থ হাসপাতাল ডিরেক্টরি': {'বাংলা': 'নিকটস্থ হাসপাতাল ডিরেক্টরি', 'English': 'Nearby Hospital Directory'},
    'দূরত্ব: ৪.৮ কি.মি.': {'বাংলা': 'দূরত্ব: ৪.৮ কি.মি.', 'English': 'Distance: 4.8 km'},
    'সময়: ১২ মিনিট': {'বাংলা': 'সময়: ১২ মিনিট', 'English': 'Time: 12 minutes'},
    'জরুরি ফোন': {'বাংলা': 'জরুরি ফোন', 'English': 'Emergency Call'},
    'দিকনির্দেশনা': {'বাংলা': 'দিকনির্দেশনা', 'English': 'Directions'},
    'জিপিএস রুট সক্রিয়': {'বাংলা': 'জিপিএস রুট সক্রিয়', 'English': 'GPS Route Active'},

    // Gorvokalin Sheba Screen (Pregnancy Care)
    'নিয়মিত যত্ন ও স্বাস্থ্যকর অভ্যাস': {'বাংলা': 'নিয়মিত যত্ন ও স্বাস্থ্যকর অভ্যাস', 'English': 'Regular care & healthy habits'},
    'প্রতিদিনের কাজ': {'বাংলা': 'প্রতিদিনের কাজ', 'English': 'Daily Tasks'},
    'ANC সময়সূচী': {'বাংলা': 'ANC সময়সূচী', 'English': 'ANC Schedule'},
    'খাদ্য গাইড': {'বাংলা': 'খাদ্য গাইড', 'English': 'Diet Guide'},
    'ব্যায়াম ও সুস্থতা': {'বাংলা': 'ব্যায়াম ও সুস্থতা', 'English': 'Exercise & Wellness'},
    'আজকের স্বাস্থ্য লক্ষ্যমাত্রা': {'বাংলা': 'আজকের স্বাস্থ্য লক্ষ্যমাত্রা', 'English': "Today's Health Goals"},
    '✅ খাওয়া উচিত': {'বাংলা': '✅ খাওয়া উচিত', 'English': '✅ Should Eat'},
    '❌ এড়িয়ে চলুন': {'বাংলা': '❌ এড়িয়ে চলুন', 'English': '❌ Avoid'},

    // PNC Screen
    'প্রসব পরবর্তী (PNC) সেবা': {'বাংলা': 'প্রসব পরবর্তী (PNC) সেবা', 'English': 'Postnatal (PNC) Care'},
    'প্রসবের পরের যত্ন': {'বাংলা': 'প্রসবের পরের যত্ন', 'English': 'Post-delivery Care'},
    'প্রসব পরবর্তী চেকআপ সূচি': {'বাংলা': 'প্রসব পরবর্তী চেকআপ সূচি', 'English': 'Postnatal Checkup Schedule'},
    'মায়ের যত্ন': {'বাংলা': 'মায়ের যত্ন', 'English': "Mother's Care"},
    'বুকের দুধ খাওয়ানো': {'বাংলা': 'বুকের দুধ খাওয়ানো', 'English': 'Breastfeeding'},
    'এই লক্ষণগুলো দেখলে দ্রুত ডাক্তার দেখান': {'বাংলা': 'এই লক্ষণগুলো দেখলে দ্রুত ডাক্তার দেখান', 'English': 'See a doctor quickly if you see these signs'},

    // Pregnancy Registration Screen
    'গর্ভবতীর তথ্য ফরম ও সেবা কার্ড': {'বাংলা': 'গর্ভবতীর তথ্য ফরম ও সেবা কার্ড', 'English': 'Pregnancy Info Form & Care Card'},
    'সফলভাবে সংরক্ষিত হয়েছে!': {'বাংলা': 'সফলভাবে সংরক্ষিত হয়েছে!', 'English': 'Successfully saved!'},
    'পূর্ববর্তী': {'বাংলা': 'পূর্ববর্তী', 'English': 'Previous'},
    'পরবর্তী ধাপে যান': {'বাংলা': 'পরবর্তী ধাপে যান', 'English': 'Go to Next Step'},
    'সংরক্ষণ করুন': {'বাংলা': 'সংরক্ষণ করুন', 'English': 'Save'},
    'ছবি': {'বাংলা': 'ছবি', 'English': 'Photo'},
    'নতুন সারি যুক্ত করুন': {'বাংলা': 'নতুন সারি যুক্ত করুন', 'English': 'Add new row'},

    // Pregnancy Health Issues Screen
    'গর্ভকালীন স্বাস্থ্য সমস্যা': {'বাংলা': 'গর্ভকালীন স্বাস্থ্য সমস্যা', 'English': 'Pregnancy Health Issues'},
    'সমস্যা চিহ্নিত করুন ও সমাধান পান': {'বাংলা': 'সমস্যা চিহ্নিত করুন ও সমাধান পান', 'English': 'Identify problems & find solutions'},
    'লক্ষণ চেকার': {'বাংলা': 'লক্ষণ চেকার', 'English': 'Symptom Checker'},
    'বিপদের লক্ষণ': {'বাংলা': 'বিপদের লক্ষণ', 'English': 'Warning Signs'},
    'ডাক্তার কল': {'বাংলা': 'ডাক্তার কল', 'English': 'Doctor Call'},
    'জরুরি সেবা দরকার?': {'বাংলা': 'জরুরি সেবা দরকার?', 'English': 'Need Emergency Service?'},
    'যেকোনো জরুরি অবস্থায় নিচের নম্বরে কল করুন': {'বাংলা': 'যেকোনো জরুরি অবস্থায় নিচের নম্বরে কল করুন', 'English': 'Call the numbers below for any emergency'},
    'এখনই ডাক্তারকে কল করুন': {'বাংলা': 'এখনই ডাক্তারকে কল করুন', 'English': 'Call doctor now'},
    // Auto-extracted translations
    'গর্ভবতীর সম্পূর্ণ তথ্য, সেবা কার্ড ও প্রসবোত্তর তথ্য সফলভাবে যুক্ত হয়েছে।': {'বাংলা': 'গর্ভবতীর সম্পূর্ণ তথ্য, সেবা কার্ড ও প্রসবোত্তর তথ্য সফলভাবে যুক্ত হয়েছে।', 'English': 'Pregnancy details, care card, and postnatal info successfully added.'},
    '🩺': {'বাংলা': '🩺', 'English': '🩺'},
    '🆘': {'বাংলা': '🆘', 'English': '🆘'},
    'যেকোনো ওষুধ গ্রহণের আগে অবশ্যই আপনার ডাক্তার বা স্বাস্থ্যকর্মীর পরামর্শ নিন।': {'বাংলা': 'যেকোনো ওষুধ গ্রহণের আগে অবশ্যই আপনার ডাক্তার বা স্বাস্থ্যকর্মীর পরামর্শ নিন।', 'English': 'Always consult your doctor or health worker before taking any medicine.'},
    '🤱': {'বাংলা': '🤱', 'English': '🤱'},
    '✅': {'বাংলা': '✅', 'English': '✅'},
    '🧘‍♀️ মেডিটেশন ও মানসিক শান্তি': {'বাংলা': '🧘‍♀️ মেডিটেশন ও মানসিক শান্তি', 'English': '🧘‍♀️ Meditation & Mental Peace'},
    'প্রতিদিন ১০ মিনিট গভীর শ্বাস-প্রশ্বাস বা মেডিটেশন করুন। মানসিক চাপ কমলে শিশু ও মা উভয়েরই উপকার হয়।': {'বাংলা': 'প্রতিদিন ১০ মিনিট গভীর শ্বাস-প্রশ্বাস বা মেডিটেশন করুন। মানসিক চাপ কমলে শিশু ও মা উভয়েরই উপকার হয়।', 'English': 'Do deep breathing or meditation for 10 mins daily. Less stress benefits both mother and baby.'},
    '👩‍👶': {'বাংলা': '👩‍👶', 'English': '👩‍👶'},
    'প্রসবের পর প্রথম ৬ সপ্তাহ মা ও শিশু উভয়ের জন্যই অত্যন্ত গুরুত্বপূর্ণ সময়।': {'বাংলা': 'প্রসবের পর প্রথম ৬ সপ্তাহ মা ও শিশু উভয়ের জন্যই অত্যন্ত গুরুত্বপূর্ণ সময়।', 'English': 'The first 6 weeks after delivery are crucial for both mother and baby.'},
    'রক্তদাতা হিসেবে যুক্ত হোন': {'বাংলা': 'রক্তদাতা হিসেবে যুক্ত হোন', 'English': 'Join as a Blood Donor'},
    'রক্তদাতা হিসেবে সফলভাবে নিবন্ধন সম্পন্ন হয়েছে!': {'বাংলা': 'রক্তদাতা হিসেবে সফলভাবে নিবন্ধন সম্পন্ন হয়েছে!', 'English': 'Successfully registered as a blood donor!'},
    'দয়া করে সব তথ্য সঠিকভাবে পূরণ করুন।': {'বাংলা': 'দয়া করে সব তথ্য সঠিকভাবে পূরণ করুন।', 'English': 'Please fill in all information correctly.'},
    'রক্তের জরুরি অনুরোধ তৈরি করুন': {'বাংলা': 'রক্তের জরুরি অনুরোধ তৈরি করুন', 'English': 'Create Emergency Blood Request'},
    'রক্তের জরুরি অনুরোধটি সফলভাবে পোস্ট করা হয়েছে!': {'বাংলা': 'রক্তের জরুরি অনুরোধটি সফলভাবে পোস্ট করা হয়েছে!', 'English': 'Emergency blood request posted successfully!'},
    'উক্ত গ্রুপ বা জেলায় কোনো রক্তদাতা খুঁজে পাওয়া যায়নি।': {'বাংলা': 'উক্ত গ্রুপ বা জেলায় কোনো রক্তদাতা খুঁজে পাওয়া যায়নি।', 'English': 'No blood donor found in this group or district.'},
    'গর্ভকালীন বা অন্য যেকোনো জরুরি মুহূর্তে নিচের টোল-ফ্রি বা বিশেষজ্ঞ হেল্পলাইনগুলোতে তাৎক্ষণিক পরামর্শ ও সহায়তার জন্য কল করুন।': {'বাংলা': 'গর্ভকালীন বা অন্য যেকোনো জরুরি মুহূর্তে নিচের টোল-ফ্রি বা বিশেষজ্ঞ হেল্পলাইনগুলোতে তাৎক্ষণিক পরামর্শ ও সহায়তার জন্য কল করুন।', 'English': 'Call the toll-free or expert helplines below for immediate advice and assistance during pregnancy or any emergency.'},
    'আমার অবস্থান': {'বাংলা': 'আমার অবস্থান', 'English': 'My Location'},
    'জিপিএস রুট সক্রিয়': {'বাংলা': 'জিপিএস রুট সক্রিয়', 'English': 'GPS Route Active'},
    'সময়: ১২ মিনিট': {'বাংলা': 'সময়: ১২ মিনিট', 'English': 'Time: 12 mins'},
    'উক্ত ফিল্টারে কোনো হাসপাতাল খুঁজে পাওয়া যায়নি।': {'বাংলা': 'উক্ত ফিল্টারে কোনো হাসপাতাল খুঁজে পাওয়া যায়নি।', 'English': 'No hospital found with this filter.'},
    'সময়মতো টিকা দিন, শিশু থাকবে সুরক্ষিত': {'বাংলা': 'সময়মতো টিকা দিন, শিশু থাকবে সুরক্ষিত', 'English': 'Vaccinate on time, keep baby safe'},
    'সরকারি টিকা (EPI)': {'বাংলা': 'সরকারি টিকা (EPI)', 'English': 'Govt Vaccines (EPI)'},
    'বেসরকারি/অতিরিক্ত টিকা': {'বাংলা': 'বেসরকারি/অতিরিক্ত টিকা', 'English': 'Private/Extra Vaccines'},
    'i': {'বাংলা': 'i', 'English': 'i'},
    'জাতীয় টিকাদান কর্মসূচি (EPI) অনুযায়ী সরকারি টিকা বিনামূল্যে দেওয়া হয়। বেসরকারি টিকা ঐচ্ছিক, তবে অতিরিক্ত সুরক্ষার জন্য প্রয়োজন হতে পারে।': {'বাংলা': 'জাতীয় টিকাদান কর্মসূচি (EPI) অনুযায়ী সরকারি টিকা বিনামূল্যে দেওয়া হয়। বেসরকারি টিকা ঐচ্ছিক, তবে অতিরিক্ত সুরক্ষার জন্য প্রয়োজন হতে পারে।', 'English': 'Govt vaccines are free under EPI. Private vaccines are optional but may be needed for extra protection.'},
    'বেসরকারি / অতিরিক্ত টিকা (ঐচ্ছিক)': {'বাংলা': 'বেসরকারি / অতিরিক্ত টিকা (ঐচ্ছিক)', 'English': 'Private / Extra Vaccines (Optional)'},
    'দ্রষ্টব্য: সময়মতো সব টিকা দিন এবং টিকাদান কার্ড সাথে রাখুন। যে কোনো প্রশ্নে আপনার নিকটস্থ স্বাস্থ্যকেন্দ্রে যোগাযোগ করুন।': {'বাংলা': 'দ্রষ্টব্য: সময়মতো সব টিকা দিন এবং টিকাদান কার্ড সাথে রাখুন। যে কোনো প্রশ্নে আপনার নিকটস্থ স্বাস্থ্যকেন্দ্রে যোগাযোগ করুন।', 'English': 'Note: Vaccinate on time and keep the card. Contact your nearest health center for any questions.'},
    '২৮তম সপ্তাহ থেকে প্রতিদিন শিশুর নড়াচড়া গণনা করুন। ২ ঘণ্টার মধ্যে ১০টি কিক স্বাভাবিক।': {'বাংলা': '২৮তম সপ্তাহ থেকে প্রতিদিন শিশুর নড়াচড়া গণনা করুন। ২ ঘণ্টার মধ্যে ১০টি কিক স্বাভাবিক।', 'English': 'Count baby\'s kicks daily from 28th week. 10 kicks in 2 hours is normal.'},
    '✨': {'বাংলা': '✨', 'English': '✨'},
    '🎉 আজকের লক্ষ্য সম্পন্ন!': {'বাংলা': '🎉 আজকের লক্ষ্য সম্পন্ন!', 'English': '🎉 Today\'s goal completed!'},
    'যদি ব্যায়াম করতে ব্যথা লাগে তাহলে থামুন এবং ডাক্তারের পরামর্শ নিন। প্রস্রাব করার সময় এই ব্যায়াম করবেন না।': {'বাংলা': 'যদি ব্যায়াম করতে ব্যথা লাগে তাহলে থামুন এবং ডাক্তারের পরামর্শ নিন। প্রস্রাব করার সময় এই ব্যায়াম করবেন না।', 'English': 'Stop and consult a doctor if the exercise hurts. Do not do this while urinating.'},
    'সঠিক তথ্য দিন': {'বাংলা': 'সঠিক তথ্য দিন', 'English': 'Provide accurate info'},
    '🤰': {'বাংলা': '🤰', 'English': '🤰'},
    '• স্বাভাবিক BMI থাকলে: ১১.৫–১৬ কেজি বাড়া উচিত\n• কম ওজন থাকলে: ১২.৫–১৮ কেজি বাড়া উচিত\n• অতিরিক্ত ওজন থাকলে: ৭–১১.৫ কেজি বাড়া উচিত\n\nসঠিক ওজন ব্যবস্থাপনার জন্য ডাক্তারের পরামর্শ নিন।': {'বাংলা': '• স্বাভাবিক BMI থাকলে: ১১.৫–১৬ কেজি বাড়া উচিত\n• কম ওজন থাকলে: ১২.৫–১৮ কেজি বাড়া উচিত\n• অতিরিক্ত ওজন থাকলে: ৭–১১.৫ কেজি বাড়া উচিত\n\nসঠিক ওজন ব্যবস্থাপনার জন্য ডাক্তারের পরামর্শ নিন।', 'English': '• Normal BMI: 11.5–16 kg gain\n• Underweight: 12.5–18 kg gain\n• Overweight: 7–11.5 kg gain\n\nConsult a doctor for proper weight management.'},
    '⚠️ দ্রুত স্বাস্থ্যকর্মীর পরামর্শ নিন।': {'বাংলা': '⚠️ দ্রুত স্বাস্থ্যকর্মীর পরামর্শ নিন।', 'English': '⚠️ Consult a health worker immediately.'},
  };
